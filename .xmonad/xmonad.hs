...
myBrowser :: String
myBrowser = "qutebrowser file:///home/mitas/CarnelianOS/startpage/index.html"  -- Sets qutebrowser as browser

--myBrowser :: String
--myBrowser = "google-chrome file:///home/mitas/CarnelianOS/startpage/index.html"  -- Sets qutebrowser as browser
-- /home/mitas/MitasTechBrowser

--myBrowser :: String
--myBrowser = "python ~/MitasTechBrowser/MitasTech-Browser.py" --Sets MitasTech Browser as Broswer
...
myManageHook = composeAll
   ...
   --  , className =? "qutebrowser"     --> doShift ( myWorkspaces !! 1)
     , className =? "whatsapp-nativefier"   --> doShift ( myWorkspaces !! 5)
...
myKeys =
    ...
    -- KB_GROUP Run Prompt
        , ("M-S-<Return>", spawn "~/.local/bin/dm-run") -- Dmenu
    ...
    -- launch dmenu_run, so I've decided to use M-p plus KEY for these dmenu scripts.
        ...
        , ("M-p w", spawn "whatsapp-nativefier") -- Launches Whatsapp
        , ("M-d", spawn "thunar")     -- translate text (Google Translate)

        , ("M-o", (rofi_launcher))            -- Launches rofi
        , ("M-<Escape>", spawn "~/bin/powermenu.sh")
        , ("M-<F12>", spawn "exec ~/bin/eww open-many blur_full weather profile quote search_full disturb-icon vpn-icon home_dir screenshot power_full reboot_full lock_full logout_full suspend_full")

        , ("M-S-<F12>", spawn "exec ~/bin/eww close-all")

        , ("M-<F11>", spawn "exec ~/bin/eww open-many weather_side time_side smol_calendar player_side sys_side sliders_side")

        , ("M-S-<F11>", spawn "exec ~/bin/eww close-all")
    ...
    -- KB_GROUP Multimedia Keys
        ...
        , ("<XF86HomePage>", spawn "qutebrowser CarnelianOS/startpage/index.html")
